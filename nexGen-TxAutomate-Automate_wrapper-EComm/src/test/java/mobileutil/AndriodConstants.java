...
public class AndriodConstants {
	...
	public static class Cloudfm {
		...
		public static final String msg_avtar = "//android.view.View[@content-desc='" + MobileKeywords.GetValue("avtar_messg") + "'] ";
		...
		public static final String Building_link = "//*[contains(@content-desc,'" + MobileKeywords.GetValue("BuildingName") + "')]";
	...
	public static class Amazon {
		...
		/*
		 * public static final String skip_sign_in_btn = "skip_sign_in_button"; public static final String shop_by_category_btn
		 * = "web_home_shop_by_department_label"; public static final String first_category_expand_btn =
		 * "//*[@text='Echo & Alexa']"; public static final String select_product_btn = "//*[@text='All new Amazon Echo']";
		 * //public static final String first_category_expand_btn = "//android.view.View[@content-desc='Echo & Alexa']";
		 * //public static final String select_product_btn = "//android.view.View[7]"; public static final String
		 * add_to_cart_btn = "//*[@text='Pre-order: Add to Cart']"; //public static final String add_to_cart_btn =
		 * "//*[@text='Add to Shopping Cart'']"; public static final String checkout_cart_img = "action_bar_cart_image"; public
		 * static final String sign_In_btn = "sign_in_button"; public static final String email_Login_txtbx = "ap_email_login";
		...
		public static final String second_category_expand_btn = "//*[@content-desc='All-new Fire TV Stick (3rd Gen)']";
		...
		public static final String Search = "//android.widget.EditText[@text='Search']";
		...
		// public static final String add_to_cart_btn2="//android.widget.Button[@resource-id='add-to-cart-button']";
		...
		public static final String checkout_cart_img = "//android.widget.ImageView[@text='Cart']";

		// public static final String checkout_cart_img = "//android.widget.ImageView[@content-desc='Cart']";
		...
		public static final String continue_btn = "continue";
		public static final String Apply_Pincode = "//android.widget.Button[contains(@text,'Apply')]";

		public static final String BreadcrumbIcon = "//android.widget.ImageView[@resource-id='in.amazon.mShop.android.shopping:id/action_bar_burger_icon']";
		public static final String HindiRadiobutton = "//android.widget.RadioButton[@resource-id='language-options-opt-1']";
		public static final String HindiButton = "//android.widget.Button[@text='हिंदी में जारी रखें']";
		public static final String Language = "//android.widget.TextView[@text='Language A/क']";

		public static final String preference = "//android.widget.TextView[@text='Preference']";
		public static final String preferenceDependency = "//android.widget.TextView[@content-desc='3. Preference dependencies']";
		public static final String wifiCheckbox = "android:id/checkbox";
		public static final String wifiSettings = "//android.widget.TextView[@text='WiFi settings']";
		public static final String wifiSettingsInput = "android:id/edit";
		public static final String okButton = "android:id/button1";
